...
public class UpdateAvatarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // initial UI
        avatarImage = (ImageView) findViewById(R.id.avatarImage_UpdateAvatarActivity);
        addImage = (ImageView) findViewById(R.id.addavatarImage_UpdateAvatarActivity);
        updateButton= (Button) findViewById(R.id.updateButton_UpdateAvatarActivity);
        backButton = (ImageView) findViewById(R.id.backButton_UpdateAvatarActivity);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQ_CODE_PICK_IMAGE && resultCode == Activity.RESULT_OK) {
            if (data != null && data.getData() != null) {
                ...
                Glide.with(this).load(imageUriGlobal).apply(RequestOptions.diskCacheStrategyOf(DiskCacheStrategy.NONE).circleCrop().error(R.mipmap.ic_avatar_error)).into(avatarImage);
            }
        }
    }
    ...
    private void updateImage() {
        ...
        String imageName = "avatar_" + userName + '.' + getFileExtension(imageUriGlobal);
        MultipartBody.Part body =
                MultipartBody.Part.createFormData("file",imageName, requestFile);
        ResponseBody userNamePart = ResponseBody.create(MediaType.parse("text/plain"),userName);
        // finally, execute the request
        Call<ResponseBody> call = accountService.updateAvatar(body, userName );
